  ...
  return (
    <div className="d-flex flex-row justify-content-center mt-5">
      <div className="d-flex flex-column justify-content-center pt-3">
        ...
        />
        <button className="btn btn-primary mt-3 mb-3" onClick={getDataID}>
          Get
        </button>
        <input
          type="text"
        ...
        <input
          ...
          value={result.gender}
          onChange={(event) => getGender(event.target.value)}
        />
        <input
          type="text"
          placeholder="Enter the Status.."
          value={result.status}
          onChange={(event) => getStatus(event.target.value)}
        />
        <button className="btn btn-primary mt-3 mb-3" onClick={getUpdateID}>
          Update
        </button>
        {result ? (
          <div className="mt-2">
